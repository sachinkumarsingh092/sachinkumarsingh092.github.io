...
This blog gives a brief overview of my project and the work done until the first evaluation.
I got seleceted for Google Summer of Code 2020 under the GNU(**G**NU's **N**ot **U**nix) project for GNU-Astro program.
...
The actual equations for the convertion is given in Appendix of the paper.
...
![SPIFFE](https://spiffe.io/img/logos/spiffe/horizontal/color/spiffe-horizontal-color.png "SPIFFE")
...
![workload API](../assets/spiffe-workload-api.png "workload API")
...
![SPIRE architecture](https://spiffe.io/img/server_and_agent.png "SPIRE architecture: Server and Agents")
...
There are two ﬂavors of attestation in SPIRE: *node* and *workload attestation*.
  ...
  ![node attestation](../assets/node-attestation.png "node attestation")
  ...
  ![workload attestation](../assets/workload-attestation.png "workload attestation") 
...
LFX mentorship was a wonderful experience for me. I learned a lot of useful stuff around microservices security, authentication used tools like delve and golang best practices. I will try my best to further contibute to SPIFFE/SPIRE. Thanks to [Evan Gilman](https://github.com/evan2645) and [Andrew Harding](https://github.com/azdagron) for all their help and guidance and making this mentroship a fun learning experience.
